document.addEventListener('DOMContentLoaded', () => {
    ...
    if (form) {
        form.addEventListener('submit', handleReportFound);
    }
});
...
async function handleReportFound(e) {
    ...
    formData.append('found_location', document.getElementById('location').value);
    ...
    try {
        const response = await fetch(`${Config.API_URL}/found/create`, {
            method: 'POST',
            headers: {
